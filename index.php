...
error_reporting(E_ALL);
  include "examen/app/config.php";
  include "examen/app/AuthController.php";
...
<html lang="en">
  ...
  <head>
    <?php include "examen/views/layouts/head.php" ?>
    <!-- <?php include "examen/views/layouts/scripts.php" ?> -->
  </head>
  <!-- [Head] end -->
  <!-- [Body] Start -->
        ...
        <div class="auth-form">
          <div class="card my-5 mx-3">
            ...
            <form action="app/AuthController.php" method="POST">
              ...
              <p class="mb-3">Don't have an Account? <a href="<?= BASE_PATH ?>register-v2.html" class="link-primary ms-1">Create Account</a></p>
              <div class="mb-3">
              ...
              <div class="d-flex mt-1 justify-content-between align-items-center">
                ...
                <a href="<?= BASE_PATH ?>forgot-password-v2.html">
